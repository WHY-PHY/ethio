...
if ( ! function_exists( 'ethiotheme_setup' ) ) :
	...
	function ethiotheme_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'ethiotheme' ),
		) );
...
function ethiotheme_content_width() {
	...
	$GLOBALS['content_width'] = apply_filters( 'ethiotheme_content_width', 640 );
}
...
function ethiotheme_widgets_init() {
	register_sidebar( array(
		'name'          => esc_html__( 'Sidebar', 'ethiotheme' ),
		'id'            => 'sidebar-1',
...
function ethiotheme_scripts() {
	...
	wp_enqueue_script( 'ethiotheme-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );
